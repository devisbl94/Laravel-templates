      ...
      <div class="container">
        ...
        <div id="navbar-collapse" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="{{ Route::currentRouteNamed('courses') ? 'active' : '' }}">
              <a href="{{ route('courses') }}">Courses</a>
            </li>
            <li class="{{ Route::currentRouteNamed('teachers') ? 'active' : '' }}">
              <a href="{{ route('teachers') }}">Teachers</a>
            </li>
            <li class="{{ Route::currentRouteNamed('events') ? 'active' : '' }}">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="{{ Route::currentRouteNamed('coursesingle') ? 'active' : '' }}">
                  <a href="{{ route('coursesingle') }}">Course Single</a>
                </li>
            ...
            <li class="{{ Route::currentRouteNamed('message.create') ? 'active' : '' }}">
